          ...
          <div className="flex flex-col items-center justify-center gap-1 mt-5">
            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <div className='bg-white dark:bg-slate-950 rounded-full p-1.5 hover:scale-110 transition-transform shadow-md '>
                ...
                <a href="https://www.linkedin.com/in/juan-f-36ba26260" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <div className='bg-white dark:bg-slate-950 rounded-full p-1.5 hover:scale-110 transition-transform shadow-md '>
                ...
                <a href="https://github.com/Juanma7882" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <div className='bg-white dark:bg-slate-950 rounded-full p-1.5 hover:scale-110 transition-transform shadow-md '>
                ...
                <a href="mailto:juanmaf236@gmail.com" className="hover:scale-110 transition-transform">
