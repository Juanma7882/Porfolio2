...
export const technologyIcons: Tecnologia[] = [
  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 47 47"><path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"></path><path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z"></path><path fill="#FFF" d="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"></path><path fill="#EEE" d="M24,30.9v4.2l-7.9-2.6L15.7,27h4l0.2,2.5L24,30.9z M19.1,17H24v-4h-9.1l0.7,12H24v-4h-4.6L19.1,17z"></path></svg>`,
  },
  {
    nombre: "CSS3",
    icono: (
    ...
    svg: `<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.902 27.201L4 5h24l-1.903 22.197L15.985 30 5.902 27.201z" fill="#264de4"/><path d="M16 27.858l8.17-2.265 1.627-18.242H16v20.507z" fill="#2965f1"/><path d="M16 13.191h4.239l.29-3.28H16V6.57h8.286l-.078.87-.802 8.993H16v-3.242z" fill="#fff"/><path d="M16.019 21.949l-.014.004-3.555-.96-.227-2.549H8.984l.447 5.006 6.575 1.823.013-.004v-3.32z" fill="#ebebeb"/><path d="M19.827 17.234l-.367 4.101-3.445.93v3.32l6.58-1.82.048-.54.753-8.43.079-.87H16v3.309h3.827z" fill="#fff"/><path d="M16.006 6.57v3.341H8.016l-.066-.739-.15-1.663-.079-.939h8.285zM16 13.191v3.242H12.46l-.066-.739-.15-1.664-.079-.839H16z" fill="#ebebeb"/></svg>`,
  },
  {
    nombre: "JavaScript",
    icono: (
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="2.5" fill="#61dafb"/><ellipse cx="16" cy="16" rx="13" ry="5" stroke="#61dafb" stroke-width="1.2" fill="none"/><ellipse cx="16" cy="16" rx="13" ry="5" stroke="#61dafb" stroke-width="1.2" fill="none" transform="rotate(60 16 16)"/><ellipse cx="16" cy="16" rx="13" ry="5" stroke="#61dafb" stroke-width="1.2" fill="none" transform="rotate(120 16 16)"/></svg>`,
  },
  {
    nombre: "Node.js",
    icono: (
  ...
  },
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        ...
        <path fill="#b71c1c" d="M21.843 24.4c-.068 0-.137-.014-.201-.042-.199-.088-.319-.294-.296-.51.292-2.749-3.926-3.852-3.969-3.862-.174-.044-.312-.179-.359-.352s.002-.359.129-.486c.207-.207 5.139-5.098 11.327-7.784.173-.075.369-.047.515.07.145.118.212.307.174.489-1.186 5.744-6.71 12.044-6.944 12.309-.092.082-.23.141-.369.141z" />
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 7c-3.6 0-5.8 1.8-6.7 5.3 1.3-1.8 2.9-2.4 4.7-2 1 .25 1.75 1 2.57 1.83C17.8 13.4 19.17 14.7 22 14.7c3.6 0 5.8-1.8 6.7-5.3-1.3 1.8-2.9 2.4-4.7 2-1-.25-1.75-1-2.57-1.83C20.2 8.3 18.83 7 16 7zM9.3 14.7c-3.6 0-5.8 1.8-6.7 5.3 1.3-1.8 2.9-2.4 4.7-2 1 .25 1.75 1 2.57 1.83C11.13 21.1 12.5 22.4 15.33 22.4c3.6 0 5.8-1.8 6.7-5.3-1.3 1.8-2.9 2.4-4.7 2-1-.25-1.75-1-2.57-1.83C13.5 16 12.13 14.7 9.3 14.7z" fill="#38bdf8"/></svg>`,
  },
  {
    nombre: "Supabase",
    icono: (
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill="#3ECF8E" d="M43.9,22.5L27.5,43.3c-1.2,1.4-3.5,0.6-3.5-1.2V30H6.6c-2.1,0-3.3-2.5-2-4.1L20.7,5.1c1.1-1.5,3.4-0.7,3.4,1.2v12.1h17.7C44.1,18.4,45.3,20.8,43.9,22.5z"/></svg>`,
  },
  {
    nombre: "PostgreSQL",
    icono: (
      <img src="/icons/postgresql.svg" alt="Icon PostgreSQL" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
    colors: ['#336791', '#4479a1'],
  },
  {
    nombre: "NestJS",
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="40" height="40" className="w-full h-full">
  ...
  },
  {
    nombre: "Ionic",
    icono: (
      <img src="/icons/ionic.svg" alt="Icon Ionic" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
    colors: ['#3880ff', '#3171e0', '#5598ff'],
  },
  {
    nombre: "Capacitor",
    icono: (
      <img src="/icons/capacitor.svg" alt="Icon Capacitor" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
    colors: ['#11999e', '#0d7c80'],
  },
  {
    nombre: "Chart.js",
    icono: (
      <img src="/icons/chartjs.svg" alt="Icon Chart.js" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
  ...
  },
  {
    nombre: "PowerShell",
    icono: (
      <img src="/icons/powershell.svg" alt="Icon PowerShell" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
    colors: ['#012456', '#5391fe'],
  },
  {
    nombre: "MySQL",
    icono: (
      <img src="/icons/mysql.svg" alt="Icon MySQL" className="w-full h-full object-contain" loading="lazy" decoding="async" />
    ),
