...
export const technologyIcons: Tecnologia[] = [
  {
    nombre: "Vite",
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        ...
        </linearGradient><path fill="url(#oOTIjsOjTqJdvfy5S4iCZa_dJjTWMogzFzg_gr1)" d="M44.86,9.976L25.023,45.448c-0.41,0.732-1.462,0.737-1.878,0.008L2.915,9.979 C2.462,9.185,3.141,8.223,4.041,8.384l19.859,3.55c0.127,0.023,0.256,0.022,0.383-0.001l19.443-3.544 C44.623,8.225,45.305,9.18,44.86,9.976z"></path>
  ...
  },
  {
    nombre: "JavaScript",
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className="w-full h-full" viewBox="0 0 48 48">
...

  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        <linearGradient id="typescript-gradient" x1="6" x2="42" y1="24" y2="24" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#0d61a9" />
          <stop offset="1" stopColor="#16528c" />
        </linearGradient>
        <path fill="url(#typescript-gradient)" d="M40,6H8C6.895,6,6,6.895,6,8v32c0,1.105,0.895,2,2,2h32c1.105,0,2-0.895,2-2V8C42,6.895,41.105,6,40,6z" />
        <path fill="#fff" d="M29.832,33.824c0.45,0.485,0.809,0.998,1.284,1.359c1.031,0.784,2.197,0.921,3.401,0.413c0.579-0.244,0.917-0.716,0.937-1.35c0.018-0.56-0.252-1.019-0.741-1.276c-0.942-0.494-1.93-0.903-2.861-1.417c-0.834-0.46-1.705-0.916-2.405-1.546c-1.855-1.67-1.851-4.942-0.132-6.617c0.935-0.911,2.064-1.351,3.374-1.385c4.31,0,5.279,2.716,5.279,2.716c-0.715,0.517-2.714,1.803-2.714,1.803c-0.358-0.549-1.09-1.246-1.747-1.37c-0.826-0.155-1.593,0.159-1.855,0.798c-0.302,0.737-0.04,1.466,0.782,1.905c0.979,0.522,1.997,0.973,2.997,1.457c0.98,0.474,1.918,1.018,2.592,1.899c1.704,2.229,1.365,6.494-2.537,7.506c-2.133,0.553-4.218,0.427-6.177-0.718c-0.923-0.539-1.783-1.581-2.311-2.488C27,35.513,28.967,34.329,29.832,33.824z" />
  ...
  },
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        <path fill="#388e3c" d="M17.204 19.122l-4.907 2.715c-.184.102-.297.29-.297.492v5.433c0 .203.113.39.297.492l4.908 2.717c.183.101.41.101.593 0l4.907-2.717c.184-.102.297-.29.297-.492v-5.433c0-.203-.113-.39-.297-.492l-4.906-2.715c-.092-.051-.195-.076-.297-.076-.103 0-.205.025-.297.076z" />
        <path fill="#37474f" d="M35.751 13.364l-2.389-1.333c-.075-.042-.167-.041-.241.003-.074.044-.12.123-.12.209l.001 7.054-2.203-1.219c-.092-.051-.195-.076-.297-.076-.102 0-.205.025-.297.076h.001l-4.907 2.715c-.184.102-.297.29-.297.492v5.433c0 .203.113.39.297.492l4.908 2.717c.183.101.41.101.593 0l4.907-2.717c.184-.102.297-.29.297-.492V13.788c0-.176-.096-.338-.249-.424zM32.866 26.458l-2.23 1.235c-.083.046-.186.046-.269 0l-2.231-1.235c-.084-.046-.135-.132-.135-.224v-2.47c0-.092.051-.177.135-.224l2.231-1.234h-.001c.042-.023.088-.034.135-.034.047 0 .093.012.135.034l2.23 1.234c.084.047.135.132.135.224v2.47c0 .092-.051.177-.135.224z" />
        <path fill="#2e7d32" d="M17.204 19.122L12 27.762c0 .203.113.39.297.492l4.908 2.717c.183.101.41.101.593 0L23 22.329c0-.203-.113-.39-.297-.492l-4.906-2.715c-.092-.051-.195-.076-.297-.076-.103 0-.205.025-.297.076z" />
        <path fill="#4caf50" d="M17.204 19.122l-4.907 2.715c-.184.102-.297.29-.297.492l5.204 8.642c.183.101.41.101.593 0l4.907-2.717c.184-.102.297-.29.297-.492l-5.203-8.64c-.092-.051-.195-.076-.297-.076-.103 0-.205.025-.297.076z" />
        <path fill="#37474f" d="M47.703 21.791l-4.906-2.715c-.092-.051-.195-.076-.297-.076-.102 0-.205.025-.297.076h.001l-4.907 2.715c-.184.102-.297.294-.297.503v5.411c0 .209.114.402.297.503l4.908 2.717c.184.102.409.102.593 0l2.263-1.253c.207-.115.206-.412-.002-.526l-4.924-2.687c-.08-.044-.13-.129-.13-.221v-2.466c0-.092.05-.177.13-.221l2.235-1.236h-.001c.042-.023.088-.034.135-.034.047 0 .093.012.135.034l2.235 1.237c.08.044.13.129.13.221v2.012c0 .086.046.166.121.209.075.042.167.042.242-.001l2.398-1.393c.148-.086.24-.245.24-.417v-1.88c0-.209-.114-.402-.297-.503zM10.703 21.791l-4.906-2.715c-.092-.051-.195-.076-.297-.076-.102 0-.205.025-.297.076h.001l-4.907 2.715C.114 21.892 0 22.084 0 22.294v7.465c0 .086.046.166.121.209.075.042.167.042.242-.001l2.398-1.393c.148-.086.24-.245.24-.417v-4.393c0-.092.05-.177.13-.221l2.235-1.236h-.001c.042-.023.088-.034.135-.034.047 0 .093.012.135.034l2.235 1.237c.08.044.13.129.13.221v4.393c0 .172.091.331.24.417l2.398 1.393c.075.043.167.043.242.001.075-.043.121-.123.121-.209v-7.464c0-.209-.114-.402-.297-.503z" />
      </svg>
    ),
    colors: ['#388e3c', '#37474f', '#2e7d32', '#4caf50', '#37474f']
  },
  {
    nombre: "MongoDB",
    icono: (
  ...
  },
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        <defs>
          <linearGradient id="react-gradient-1" x1="10.925" y1="-11.924" x2="26.209" y2="30.068" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#ac5bb8" />
            <stop offset="1" stopColor="#9a259c" />
          </linearGradient>
          <linearGradient id="react-gradient-2" x1="20.213" y1="13.776" x2="36.727" y2="59.147" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#ac5bb8" />
            <stop offset="1" stopColor="#9a259c" />
          </linearGradient>
          <linearGradient id="react-gradient-3" x1="27.238" y1="2.443" x2="42.569" y2="44.566" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#ac5bb8" />
            <stop offset="1" stopColor="#9a259c" />
          </linearGradient>
        </defs>
        <path d="M22.903,3.286c0.679,-0.381 1.515,-0.381 2.193,0c3.355,1.883 13.451,7.551 16.807,9.434c0.679,0.38 1.097,1.084 1.097,1.846c0,3.766 0,15.101 0,18.867c0,0.762 -0.418,1.466 -1.097,1.847c-3.355,1.883 -13.451,7.551 -16.807,9.434c-0.679,0.381 -1.515,0.381 -2.193,0c-3.355,-1.883 -13.451,-7.551 -16.807,-9.434c-0.678,-0.381 -1.096,-1.084 -1.096,-1.846c0,-3.766 0,-15.101 0,-18.867c0,-0.762 0.418,-1.466 1.097,-1.847c3.354,-1.883 13.452,-7.551 16.806,-9.434z" fill="url(#react-gradient-1)" fillRule="evenodd" />
        <path d="M5.304,34.404c-0.266,-0.356 -0.304,-0.694 -0.304,-1.149c0,-3.744 0,-15.014 0,-18.759c0,-0.758 0.417,-1.458 1.094,-1.836c3.343,-1.872 13.405,-7.507 16.748,-9.38c0.677,-0.379 1.594,-0.371 2.271,0.008c3.343,1.872 13.371,7.459 16.714,9.331c0.27,0.152 0.476,0.335 0.66,0.576z" fill="url(#react-gradient-2)" fillRule="evenodd" />
        <path d="M24,10c7.727,0 14,6.273 14,14c0,7.727 -6.273,14 -14,14c-7.727,0 -14,-6.273 -14,-14c0,-7.727 6.273,-14 14,-14zM24,17c3.863,0 7,3.136 7,7c0,3.863 -3.137,7 -7,7c-3.863,0 -7,-3.137 -7,-7c0,-3.864 3.136,-7 7,-7z" fill="#ffffff" fillRule="evenodd" />
        <path d="M42.485,13.205c0.516,0.483 0.506,1.211 0.506,1.784c0,3.795 -0.032,14.589 0.009,18.384c0.004,0.396 -0.127,0.813 -0.323,1.127l-19.084,-10.5z" fill="url(#react-gradient-3)" fillRule="evenodd" />
        <path d="M38,20v2h2v1h-2v2h2v1h-2v2h-1v-2h-2v2h-1v-2h-2v-1h2v-2h-2v-1h2v-2h1v2h2v-2h1M35,25h2v-2h-2v2M39,19h-1h-1h-1h-1h-1h-1v1v1h-1h-1v1v1v1v1v1v1h1h1v1v1h1h1h1v-1v-1v1v1h1h1h1v-1v-1h1h1v-1v-1v-1h-1h-1h1h1v-1v-1v-1h-1h-1v-1v-1z" fill="#000000" fillRule="nonzero" opacity="0.05" />
        <path d="M38.5,19.5h-0.5h-1h-0.5v0.5v1.5h-1v-1.5v-0.5h-0.5h-1h-0.5v0.5v1.5h-1.5h-0.5v0.5v1v0.5h0.5h1.5v1h-1.5h-0.5v0.5v1v0.5h0.5h1.5v1.5v0.5h0.5h1h0.5v-0.5v-1.5h1v1.5v0.5h0.5h1h0.5v-0.5v-1.5h1.5h0.5v-0.5v-1v-0.5h-0.5h-1.5v-1h1.5h0.5v-0.5v-1v-0.5h-0.5h-1.5v-1.5v-0.5zM35.5,23.5h1v1h-1v-1z" fill="#000000" fillRule="nonzero" opacity="0.07" />
        <path d="M40,23v-1h-2v-2h-1v2h-2v-2h-1v2h-2v1h2v2h-2v1h2v2h1v-2h2v2h1v-2h2v-1h-2v-2zM37,25h-2v-2h2z" fill="#ffffff" fillRule="nonzero" />
      </svg>
    ),
  ...
  },
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        ...
        <path fill="#f2f2f2" d="M20.326,34.875c-0.451,0.219-0.949,0.324-1.45,0.306c-0.674,0.03-1.327-0.232-1.794-0.719 C16.593,33.842,16.351,33.17,16.377,32.481c-0.034-0.754,0.239-1.489,0.756-2.038c0.505-0.517,1.203-0.798,1.925-0.775 c0.427-0.015,0.853,0.06,1.25,0.219v0.625c-0.382-0.212-0.813-0.319-1.25-0.312c-0.557-0.016-1.094,0.213-1.469,0.625 C17.755,31.066,17.513,31.644,17.544,32.231c-0.029,0.559,0.159,1.108,0.525,1.531c0.355,0.382,0.86,0.59,1.381,0.569 c0.48,0.013,0.954-0.109,1.369-0.35L20.326,34.875z"></path>
        ...
        <path fill="#f2f2f2" d="M31.326,33.375h-2.644c-0.018,0.349,0.096,0.693,0.319,0.963c0.234,0.234,0.557,0.356,0.887,0.338 C29.98,34.665,30.39,34.517,30.719,34.25v0.562c-0.386,0.255-0.844,0.38-1.306,0.356c-0.472,0.024-0.93-0.164-1.25-0.513 c-0.325-0.406-0.488-0.918-0.456-1.438c-0.022-0.52,0.154-1.03,0.494-1.425c0.313-0.362,0.772-0.564,1.25-0.55 c0.432-0.024,0.851,0.151,1.138,0.475c0.288,0.379,0.43,0.85,0.4,1.325L31.326,33.375z M30.701,32.869 c0.013-0.29-0.076-0.575-0.25-0.806c-0.173-0.196-0.426-0.302-0.688-0.288c-0.272-0.003-0.533,0.108-0.719,0.306 c-0.206,0.218-0.335,0.496-0.369,0.794L30.701,32.869z"></path>
      </svg>
    ),
    colors: ['#ffffff', '#D100D1'],
  },
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-full h-full">
        <path fill="#cfd8dc" d="M23.084 11.277c-1.633-2.449-1.986-5.722-2.063-7.067-4.148.897-8.269 2.506-8.031 3.691.03.149.218.328.53.502l-.488.873c-.596-.334-.931-.719-1.022-1.179-.269-1.341 1.25-2.554 4.642-3.709 2.316-.789 4.652-1.26 4.751-1.279l.597-.12L22 3.6c0 .042.026 4.288 1.916 7.123l-.832.554z" />
        <path fill="#cfd8dc" d="M24.751 43H24.5c-8.192 0-17.309-2.573-18.386-6.879-.657-2.63 1.492-5.536 6.214-8.401l.52.854c-4.249 2.579-6.296 5.172-5.763 7.305.935 3.738 9.575 6.068 17.153 6.12.901-1.347 5.742-9.26 2.979-19.873l.967-.252c3.149 12.092-3.218 20.837-3.282 20.924l-.249.176z" />
        <path fill="#cfd8dc" d="M9.931 39.306c-.539 0-.806-.059-.85-.07-.176-.043-.314-.178-.362-.352-.049-.174.001-.361.129-.488.072-.072 7.197-7.208 8.159-12.978l.986.164c-.827 4.964-5.715 10.623-7.656 12.707 1.939-.111 6.835-1.019 16.234-6.28-7.335-.804-8.495-6.676-8.507-6.739l.983-.181c.047.246 1.226 6.011 9.244 6.011.003 0 .005 0 .008 0 .227 0 .424.152.482.37.06.218-.036.449-.231.563-7.085 3.94-12.533 4.703-14.469 4.704z" />
        <path fill="#cfd8dc" d="M14.524 41.7c-.207 0-.395-.128-.468-.325-.079-.211-.007-.45.177-.582.034-.025 1.813-1.338 3.706-4.228-.728-.322-1.465-.698-2.196-1.137-.888-.533-1.559-1.105-2.06-1.691-2.57.678-4.942.946-7.025.769l.084-.996c1.876.159 4.009-.063 6.321-.64-1.573-2.688-.129-5.356-.109-5.392l.874.487c-.067.122-1.265 2.37.249 4.633 2.201-.632 4.549-1.567 6.979-2.782.559-1.835.996-3.922 1.225-6.276.016-.161.108-.304.248-.385s.311-.088.458-.021c.032.015 3.264 1.491 5.604 2.454.17.07.288.228.307.411.02.183-.063.361-.216.465-2.289 1.56-4.563 2.913-6.778 4.042-.702 2.225-1.571 4.077-2.459 5.591 3.702 1.383 6.915 1.404 6.956 1.404.228 0 .427.154.484.375.057.221-.042.452-.241.563-4.54 2.522-11.767 3.232-12.072 3.261-.026.001-.042.002-.058.002zm4.385-4.733c-1.04 1.614-2.062 2.773-2.826 3.53 1.998-.294 5.501-.938 8.408-2.139-1.392.829-3.407 1.209-5.582.299zm-4.142-3.536c.393.392.883.775 1.49 1.14.736.442 1.483.817 2.22 1.135.754-1.264 1.501-2.781 2.142-4.568-2.261.842-4.223 1.61-6.092 2.173zm8.435-9.142c-.205 1.768-.521 3.381-.913 4.85 1.66-.885 3.354-1.896 5.062-3.026-1.149.67-2.852 1.433-3.749 1.838z" />
        <path fill="#cfd8dc" d="M17.924 10.6c-.117 0-.233-.042-.325-.12-1.61-1.378-3.505-4.182-3.585-4.301-.129-.191-.109-.446.046-.616.154-.171.408-.211.608-.102.011.003.938.385 7.217 1.431.181.03.33.156.39.328.061.172.022.364-.1.5-1.758 1.953-3.979 2.813-4.073 2.848-.047.025-.108.036-.167.036zm-2.277-3.854c.631.849 1.54 1.996 2.372 2.769.511-.233 1.657-.818 2.744-1.798-1.583-.801-3.159-1.115-4.116-1.331z" />
        <path fill="#b71c1c" d="M21.843 24.4c-.068 0-.137-.014-.201-.042-.199-.088-.319-.294-.296-.51.292-2.749-3.926-3.852-3.969-3.862-.174-.044-.312-.179-.359-.352s.002-.359.129-.486c.207-.207 5.139-5.098 11.327-7.784.173-.075.369-.047.515.07.145.118.212.307.174.489-1.186 5.744-6.71 12.044-6.944 12.309-.092.082-.23.141-.369.141zm-3.388-5.115c1.184.445 3.258 1.475 3.783 3.356 1.449-1.808 4.542-5.973 5.697-9.934-4.485 2.095-8.179 5.277-9.578 6.563z" />
        <path fill="#b71c1c" d="M13.079 28.36l-.475-.88c1.883-1.015 4.04-2.883 5.807-5.054-1.504 1.03-2.365 1.735-2.392 1.758l-.639-.77c.039-.032 1.764-1.447 4.631-3.22.787-1.266 1.392-2.568 1.703-3.816.053-.212.099-.417.136-.615-1.925-.687-3.701-1.094-4.921-1.269-.185-.026-.339-.153-.401-.328-.062-.175-.021-.371.104-.507.085-.092 2.116-2.268 4.654-3.463.197-.093.433-.047.581.114.067.073 1.44 1.615 1.091 4.805 1.155.45 2.345.997 3.491 1.648 2.759-1.24 5.892-2.356 9.229-3.03.172-.034.363.028.481.168.117.14.149.333.083.503-1.3 3.332-4.786 6.891-4.934 7.041-.101.102-.239.153-.383.148-.143-.008-.275-.076-.365-.188-1.12-1.408-2.584-2.574-4.163-3.523-2.175 1.004-4.101 2.078-5.684 3.049-2.614 1.281-5.663 4.176-8.228 5.557zm14.413-10.964c1.29.832 2.491 1.81 3.484 2.948.828-.898 2.815-3.168 3.942-5.422-2.65.6-5.158 1.483-7.426 2.464zm-4.693-1.274c-.033.163-.071.33-.113.5-.21.839-.544 1.701-.972 2.561 1.096-.626 2.309-1.272 3.618-1.898-.799-.386-1.654-.772-2.494-1.105zm-4.751-2.45c1.111.218 2.48.574 3.941 1.086.152-1.843-.346-2.972-.647-3.472-1.368.718-2.573 1.728-3.286 2.386z" />
        <path fill="#b71c1c" d="M18.05 18.5c0 4.38-3.65 7.86-6.28 10.4-.44.43-1.93.5-1.93.5.37-.38.79-.78 1.24-1.21 2.5-2.42 5.97-5.73 5.97-9.69 0-4.69-1.89-6.54-3.38-8.02-.66-.67-1.22-1.31-1.56-2.09l.31-.13c.34.15.73.32 1.03.45.24.35.56.69.93 1.06 1.49 1.48 3.63 3.58 3.63 8.68z" />
        <path fill="#b71c1c" d="M42.935 19.794s-.605.086-.775.106c-8.76.97-17.8 3.49-22.97 5.56-1.87.75-3.81 1.66-5.58 2.68-.01.01-.02.01-.04.02-1.04.74-3.57 1.98-5.62 3.07 3-3.19 8.62-5.65 10.86-6.55 5.07-2.03 13.78-4.48 22.35-5.53-1.01-1.18-3.48-3.68-8.34-5.54-2.84-1.1-7.16-1.72-10.97-2.27-6.06-.87-9.51-1.45-9.84-3.1-.07-.33-.02-.66.13-.98.33.54.8.92 1.11 1.14.15.1.26.16.3.18l.01.01c1.42.75 5.25 1.3 8.44 1.76 3.86.56 8.23 1.19 11.18 2.32 6.87 2.65 9.24 6.44 9.34 6.6.04.05.365.564.365.564z" />
      </svg>
    ),
    colors: ['#cfd8dc', '#b71c1c']
  },
  {
    nombre: "Git",
    icono: (
